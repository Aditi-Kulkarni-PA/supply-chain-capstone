...
class DatabaseOperations:
    ...
    _COLUMN_META: Dict[str, str] = {
        ...
        "delivery_mode": "Service tier (e.g. same_day, next_day, two_day, standard).",
        ...
        "weather_severity": "Ordinal encoding of weather: clear=0, hot/cold=1, rainy/foggy=2, stormy=3.",
        "mode_urgency": "Ordinal encoding of delivery mode urgency: standard=0, two_day=1, next_day=2, same_day=3.",
        "schedule_risk": "km_per_expected_hr × mode_urgency. Combines schedule tightness with urgency.",
        "vehicle_capacity": "Ordinal vehicle capacity: bike=0, ev_bike=1, van=2, truck=3.",
        "vehicle_load_strain": "package_weight_kg / vehicle_capacity. Higher = more strain on vehicle.",
